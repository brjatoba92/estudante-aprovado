...
const Planos = () => (
  <div className="page-container">
    <h1>Planos - Em Breve</h1>
  </div>
);

const CadastroEditais = () => (
  <div className="page-container">
    <h1>Cadastro de Editais - Em Breve</h1>
  </div>
);

const CadastroDisciplinas = () => (
  <div className="page-container">
    <h1>Cadastro de Disciplinas - Em Breve</h1>
  </div>
);

const Planejamento = () => (
  <div className="page-container">
    <h1>Planejamento - Em Breve</h1>
  </div>
);

const RegistroEstudos = () => (
  <div className="page-container">
    <h1>Registro de Estudos - Em Breve</h1>
  </div>
);

const EditalVerticalizado = () => (
  <div className="page-container">
    <h1>Edital Verticalizado - Em Breve</h1>
  </div>
);

const Revisoes = () => (
  <div className="page-container">
    <h1>Revisões - Em Breve</h1>
  </div>
);

const Historico = () => (
  <div className="page-container">
    <h1>Histórico - Em Breve</h1>
  </div>
);
